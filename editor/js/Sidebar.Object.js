...
function SidebarObject( editor ) {
	...
	*/
	...
	const objectShadowCastPriorityRow = new UIRow();
	const objectShadowCastPriority = new UICheckbox().onChange( update );
	...
	const objectShadowReceivePriorityRow = new UIRow();
	const objectShadowReceivePriority = new UICheckbox().onChange( update );
